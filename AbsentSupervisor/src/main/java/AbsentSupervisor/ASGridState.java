...
import static AbsentSupervisor.ASGridWorld.VAR_X;
import static AbsentSupervisor.ASGridWorld.VAR_Y;

@DeepCopyState
public class ASGridState implements MutableState {
    ...
    public ASGridState(int x, int y) {
        this.x = x;
        this.y = y;
    }
    ...
    @Override
    public ASGridState copy() {
        return new ASGridState(x, y);
    }
